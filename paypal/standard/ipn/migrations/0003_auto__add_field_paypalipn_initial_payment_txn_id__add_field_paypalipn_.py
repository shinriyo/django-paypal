...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'paypal_ipn', 'initial_payment_txn_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=19, blank=True),
                      keep_default=False)

        # Adding field 'PayPalIPN.initial_payment_status'
        db.add_column(u'paypal_ipn', 'initial_payment_status',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'paypal_ipn', 'initial_payment_txn_id')

        # Deleting field 'PayPalIPN.initial_payment_status'
        db.delete_column(u'paypal_ipn', 'initial_payment_status')
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'initial_payment_status': ('django.db.models.fields.CharField', [], {'max_length': '17', 'blank': 'True'}),
